...
- #1337: Unhandled exception after closing ShimanoRDP
...
- #1385: Added option to start ShimanoRDP minimized
...
- #1468: Improved ShimanoRDP startup time
- #1443: Chinese (simplified) translation improvements
- #1437: Norwegian translation improvements
- #1378: Hyperlinks embedded within ShimanoRDP now open in the system default browser
...
- #1218: A splashscreen has been added when ShimanoRDP starts
- #1216: Connection tree search bar can be placed at the top or bottom of connection tree
- #1201: The help files packaged with ShimanoRDP have been rewritten
...
### Added
- #625: Added ability to import ShimanoRDP formatted CSV files
...
- #519: You can now import normal ShimanoRDP files - they do not have to be exports
...
- Improved compatability between environments when building ShimanoRDP from source
### Removed
...
### Changed
- #810: Official ShimanoRDP builds will now be signed with a DigiCert certificate
### Fixed
...
- #610: ShimanoRDP cannot start /crashes for some users on Windows server 2012 R2 server
...
### Fixed
- #583: SSH (PuTTYNG) Sessions are not properly integrated into the main ShimanoRDP window (Sorry!)
...
### Fixed
- MR-905: ShimanoRDP crashes at startup (in FIPS policy check)
- MR-902: ShimanoRDP crashes after locking/unlocking the local system after loading a VNC connection
...
## [1.71] - 2013-10-29
### Removed
- Removed warning message when ShimanoRDP is started for the first time about new connections file being created.
### Fixed
...
- Fixed issue MR-521 - Right-Clicking in "Sessions" panel crashes ShimanoRDP
...
- Fixed issue MR-439 - ShimanoRDP 1.70 does not start
...
- Added detection of newer versions of connection files and database schemata. ShimanoRDP will now refuse to open them to avoid data loss.
### Fixed
...
- Fixed issue MR-142 - Start of ShimanoRDP takes about one minute and consumes excessive CPU
...
- Fixed issue MR-352 - Passwords with " (quotation mark) and # (hash key) characters make ShimanoRDP to open PuttyNG dialog
...
- Fixed issue MR-338 - PuTTYNG crashing on fresh install of ShimanoRDP
Re-enabled PuTTYNG integration enhancements on Windows 8
...
### Changed
- ShimanoRDP now requires .NET Framework 3.0 instead of 2.0.
- Updated translations.
- Improved the use of Tab and Shift-Tab to cycle through entries in the Config grid.
- Improved loading of XML files from older versions of mRemote/ShimanoRDP.
### Fixed
...
- Fixed issue MR-71 - Minimizing ShimanoRDP causes temporary re-size of Putty sessions (windows)
...
- Fixed issue MR-199 - when using screen inside putty, screen becomes dead when reduce ShimanoRDP
...
- Fixed issue MR-299 - ShimanoRDP crashes while using remotely (Windows XP remote desktop)
...
- Fixed issue MR-93 - Regional settings problem when using SQL connection in ShimanoRDP
...
- Fixed issue #72 - scrollbars added to RDP window after minimize/restore of ShimanoRDP
...
- Added the ShimanoRDP icon to the list of selectable icons for connection entries.
- Added confirmation before closing connection tabs.
### Changed
- Updated graphics in the installer to ShimanoRDP logo.
...
### Changed
- Ctrl-Tab and Ctrl-Shift-Tab no longer work to switch tabs within ShimanoRDP
### Fixed
- Fixed Ctrl-Tab and Ctrl-Shift-Tab not working in any other applications while ShimanoRDP is running
...
- Changed the internal namespace of the application to ShimanoRDP instead of mRemote
...
- Fixed bug 25 - Unhandled exception when ShimanoRDP opens
...
## [1.61] - 2010-01-14
### Changed
- This version of ShimanoRDP does not support VNC
### Removed
...
- Changed website links in Help menu and About page to load within ShimanoRDP instead of launching an external browser
...
[Unreleased]: https://github.com/ShimanoRDP/ShimanoRDP/compare/v1.76.20..HEAD
[1.76.20]: https://github.com/ShimanoRDP/ShimanoRDP/compare/v1.76.19..v1.76.20
[1.76.19]: https://github.com/ShimanoRDP/ShimanoRDP/compare/v1