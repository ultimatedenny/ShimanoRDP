...
namespace ShimanoRDP.Config.Serializers.ConnectionSerializers.Csv
{
    public class CsvConnectionsSerializerShimanoRDPFormat : ISerializer<ConnectionInfo, string>
    {
        ...
        public CsvConnectionsSerializerShimanoRDPFormat(SaveFilter saveFilter,
