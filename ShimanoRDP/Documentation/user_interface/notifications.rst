...
The notifications panel contains any errors or informational messages that ShimanoRDP triggers.
...
This will tell ShimanoRDP what type of messages and the level of messages to send to the panel. It does not the level for the log that ShimanoRDP has but only for panel output.
...
Good when for example reporting issues about ShimanoRDP or to check more details about problems.
