...
You can import or export your connections to ShimanoRDP. Imports can be done in various
...
Import from File
----------------
Opens a normal file load dialog to open a exported xml or csv file for ShimanoRDP.
