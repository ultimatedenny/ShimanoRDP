...
It will scan a range of IP addresses and to determine if specific ShimanoRDP supported protocols are active. Hosts can then be bulk imported into ShimanoRDP.

.. tip::

    If you leave this at the default of 0 & 0, the test will be for the default protocol ports that ShimanoRDP supports.
...
- Enter the Start Port and End Port that ShimanoRDP should test for.
- Click Scan
