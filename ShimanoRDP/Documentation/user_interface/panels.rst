...
ShimanoRDP is using tabs and panels to stay organized but also to create
...
Creating manual panels will make you able to organize tabs manually in ShimanoRDP.
...
that are available in ShimanoRDP window.
...
- **Send to...** - Send the whole panel to monitor/screen *[number]*. Note this is not a real window but a detachable panel. If you double click the title then the panel will go back to ShimanoRDP window and not fullscreen the window.
