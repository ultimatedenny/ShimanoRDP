...
Folders on ShimanoRDP cannot only be used to categorize connections but also to inherit
...
In ShimanoRDP there is an easier way. You just create two folders
