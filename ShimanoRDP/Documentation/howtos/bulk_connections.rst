...
Currently, ShimanoRDP does not have a feature to support editing or creating connections in bulk.
...
You can find the most recent version `here <https://github.com/ShimanoRDP/ShimanoRDP/blob/develop/Tools/CreateBulkConnections_ConfCons2_6.ps1>`_.
...
- The script works with ShimanoRDP v1.75 and will produce XML formatted for use with confCons v2.6 files. This script may need to be updated for future versions of ShimanoRDP.
- As always, feel free to reach out to us in a `GitHub Issue <https://github.com/ShimanoRDP/ShimanoRDP/issues>`_ or on `Gitter <https://gitter.im/ShimanoRDP/PublicChat>`_ if you have issues.
