...
using ShimanoRDP.Config.Settings;
...
using ShimanoRDP.UI.Menu;
using ShimanoRDP.UI.Tabs;
using ShimanoRDP.UI.TaskDialog;
...
using Settings = ShimanoRDP.Properties.Settings;
    ...
    public partial class FrmMain
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            CefSettings settings = new CefSettings()
            {
                ...
                LogFile = Path.Combine(dir, "ShimanoRDP_cef.log"),
            };
