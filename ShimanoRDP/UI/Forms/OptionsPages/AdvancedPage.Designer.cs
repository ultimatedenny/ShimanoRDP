...
namespace ShimanoRDP.UI.Forms.OptionsPages
{
    public sealed partial class AdvancedPage : OptionsPage
	{
		...
		{
			this.lblMaximumPuttyWaitTime = new ShimanoRDP.UI.Controls.MrngLabel();
			this.chkAutomaticReconnect = new MrngCheckBox();
			this.numPuttyWaitTime = new ShimanoRDP.UI.Controls.MrngNumericUpDown();
			this.chkUseCustomPuttyPath = new MrngCheckBox();
			this.lblConfigurePuttySessions = new ShimanoRDP.UI.Controls.MrngLabel();
			this.numUVNCSCPort = new ShimanoRDP.UI.Controls.MrngNumericUpDown();
			this.txtCustomPuttyPath = new ShimanoRDP.UI.Controls.MrngTextBox();
			this.btnLaunchPutty = new MrngButton();
			this.lblUVNCSCPort = new ShimanoRDP.UI.Controls.MrngLabel();
			this.lblSeconds = new ShimanoRDP.UI.Controls.MrngLabel();
			...
			this.btnLaunchPutty.Image = global::ShimanoRDP.Properties.Resources.PuttyConfig;
