namespace ShimanoRDP.UI.Forms.OptionsPages
{
    sealed partial class CredentialsPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtCredentialsUsername = new ShimanoRDP.UI.Controls.MrngTextBox();
            this.txtCredentialsPassword = new ShimanoRDP.UI.Controls.MrngTextBox();
            this.txtCredentialsDomain = new ShimanoRDP.UI.Controls.MrngTextBox();
            this.lblCredentialsDomain = new ShimanoRDP.UI.Controls.MrngLabel();
            this.lblCredentialsUsername = new ShimanoRDP.UI.Controls.MrngLabel();
            this.lblCredentialsPassword = new ShimanoRDP.UI.Controls.MrngLabel();
            this.radCredentialsCustom = new ShimanoRDP.UI.Controls.MrngRadioButton();
            this.lblDefaultCredentials = new ShimanoRDP.UI.Controls.MrngLabel();
            this.radCredentialsNoInfo = new ShimanoRDP.UI.Controls.MrngRadioButton();
            this.radCredentialsWindows = new ShimanoRDP.UI.Controls.MrngRadioButton();
