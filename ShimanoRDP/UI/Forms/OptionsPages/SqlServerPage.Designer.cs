...
namespace ShimanoRDP.UI.Forms.OptionsPages
{
    ...
    public sealed partial class SqlServerPage : OptionsPage
	{
		...
		{
            this.lblSQLDatabaseName = new ShimanoRDP.UI.Controls.MrngLabel();
            this.txtSQLDatabaseName = new ShimanoRDP.UI.Controls.MrngTextBox();
            this.lblExperimental = new ShimanoRDP.UI.Controls.MrngLabel();
            this.chkUseSQLServer = new MrngCheckBox();
            this.lblSQLUsername = new ShimanoRDP.UI.Controls.MrngLabel();
            this.txtSQLPassword = new ShimanoRDP.UI.Controls.MrngTextBox();
            this.lblSQLInfo = new ShimanoRDP.UI.Controls.MrngLabel();
            this.lblSQLServer = new ShimanoRDP.UI.Controls.MrngLabel();
            this.txtSQLUsername = new ShimanoRDP.UI.Controls.MrngTextBox();
            this.txtSQLServer = new ShimanoRDP.UI.Controls.MrngTextBox();
            this.lblSQLPassword = new ShimanoRDP.UI.Controls.MrngLabel();
            this.btnTestConnection = new MrngButton();
            this.imgConnectionStatus = new System.Windows.Forms.PictureBox();
            this.lblTestConnectionResults = new ShimanoRDP.UI.Controls.MrngLabel();
            this.chkSQLReadOnly = new MrngCheckBox();
            this.lblSQLReadOnly = new ShimanoRDP.UI.Controls.MrngLabel();
            this.lblSQLType = new ShimanoRDP.UI.Controls.MrngLabel();
            ...
            // imgConnectionStatus
            // 
            this.imgConnectionStatus.Image = global::ShimanoRDP.Properties.Resources.Help;
