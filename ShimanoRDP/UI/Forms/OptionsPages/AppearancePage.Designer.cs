...
namespace ShimanoRDP.UI.Forms.OptionsPages
{
    ...
    public sealed partial class AppearancePage : OptionsPage
	{
		...
		{
            this.lblLanguageRestartRequired = new ShimanoRDP.UI.Controls.MrngLabel();
            this.cboLanguage = new MrngComboBox();
            this.lblLanguage = new ShimanoRDP.UI.Controls.MrngLabel();
            ...
            this.lblLanguageRestartRequired.Text = "ShimanoRDP must be restarted before changes to the language will take effect.";
            // 
            // cboLanguage
            // 
