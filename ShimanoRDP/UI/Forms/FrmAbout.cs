...
namespace ShimanoRDP.UI.Forms
{
    public partial class FrmAbout : Form
    {
        ...
        {
            Process.Start("https://github.com/ShimanoRDP/ShimanoRDP/blob/develop/COPYING.TXT");
            Close();
        }

        private void llChangelog_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start("https://github.com/ShimanoRDP/ShimanoRDP/blob/develop/CHANGELOG.md");
            Close();
        }

        private void llCredits_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start("https://github.com/ShimanoRDP/ShimanoRDP/blob/develop/CREDITS.md");
            Close();
        }
    }
}