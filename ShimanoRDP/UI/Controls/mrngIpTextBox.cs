...
namespace ShimanoRDP.UI.Controls
{
    ...
    public class MrngIpTextBox : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Octet4 = new ShimanoRDP.UI.Controls.MrngTextBox();
            this.Octet3 = new ShimanoRDP.UI.Controls.MrngTextBox();
            this.Octet2 = new ShimanoRDP.UI.Controls.MrngTextBox();
            this.Octet1 = new ShimanoRDP.UI.Controls.MrngTextBox();
            this.label2 = new ShimanoRDP.UI.Controls.MrngLabel();
            this.label1 = new ShimanoRDP.UI.Controls.MrngLabel();
            this.label3 = new ShimanoRDP.UI.Controls.MrngLabel();
