...
namespace ShimanoRDP.UI.TaskDialog
{
  partial class frmTaskDialog
  {
    ...
    private void InitializeComponent()
    {
            ...
            this.lbFooter = new ShimanoRDP.UI.Controls.MrngLabel();
            this.bt1 = new MrngButton();
            this.bt2 = new MrngButton();
            this.bt3 = new MrngButton();
            this.cbVerify = new MrngCheckBox();
            this.lbShowHideDetails = new ShimanoRDP.UI.Controls.MrngLabel();
            this.lbExpandedInfo = new ShimanoRDP.UI.Controls.MrngLabel();
            this.lbContent = new ShimanoRDP.UI.Controls.MrngLabel();
            this.lbMainInstruction = new ShimanoRDP.UI.Controls.MrngLabel();
