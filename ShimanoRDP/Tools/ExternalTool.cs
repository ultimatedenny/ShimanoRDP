...
namespace ShimanoRDP.Tools
{
    public class ExternalTool : INotifyPropertyChanged
    {
        ...
        public Icon Icon
        {
            get { return File.Exists(FileName) ? MiscTools.GetIconFromFile(FileName) : Properties.Resources.ShimanoRDP_Icon; }
        }

        public Image Image
        {
            get { return Icon?.ToBitmap() ?? Properties.Resources.ShimanoRDP_Icon.ToBitmap(); }
        }
