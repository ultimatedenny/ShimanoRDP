...
using System.IO;
using System.Xml;
using ShimanoRDP.Resources.Themes;

namespace ShimanoRDP.Themes
{
    //Class to extract the rest of the required theme colors for ShimanoRDP from the vstheme file
    public class ShimanoRDPPaletteManipulator
    {
        ...
        public ShimanoRDPPaletteManipulator(byte[] file, ExtendedColorPalette defaultPalette = null)
        {
        ...
        //Load the colors for the ShimanoRDP own components as Dockpanel only have a menus and docks palette
