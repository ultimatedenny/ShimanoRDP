...
namespace ShimanoRDP.App
{
    public class Logger
    {
        ...
        {
            XmlConfigurator.Configure(LogManager.CreateRepository("ShimanoRDP"));
        ...
        {
            var repository = LogManager.GetRepository("ShimanoRDP");
            ...
            Log = LogManager.GetLogger("ShimanoRDP", "Logger");
        }
        ...
        private static string BuildLogFilePath()
        {
            ...
            if (logFileName == null) return "ShimanoRDP.log";
