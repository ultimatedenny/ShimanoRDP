...
{
    public class CsvConnectionsDeserializerShimanoRDPFormatTests
    {
        private CsvConnectionsDeserializerShimanoRDPFormat _deserializer;
        private CsvConnectionsSerializerShimanoRDPFormat _serializer;

        [SetUp]
        public void Setup()
        {
            _deserializer = new CsvConnectionsDeserializerShimanoRDPFormat();
            var credentialRepositoryList = Substitute.For<ICredentialRepositoryList>();
            _serializer = new CsvConnectionsSerializerShimanoRDPFormat(new SaveFilter(), credentialRepositoryList);
        }
