...
namespace ShimanoRDPTests.Config.Serializers.ConnectionSerializers.Xml
{
    public class ValidateXmlSchemas
    {
        ...
        public void ValidateSchema()
        {
            ...
            var schemaFileName = $"ShimanoRDP_confcons_v{_serializer.Version.Major}_{_serializer.Version.Minor}.xsd";
            var schemaFile = GetTargetPath(schemaFileName);
            _xmlReaderSettings.Schemas.Add("http://ShimanoRDP.org", schemaFile);
